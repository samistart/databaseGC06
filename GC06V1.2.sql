...
DROP DATABASE `GC06V1.2`;
CREATE DATABASE `GC06V1.2`;
USE `GC06V1.2`; 
...
INSERT INTO `GC06V1.2`.`groups` (`groupID`, `groupName`, `averageGrade`, `ranking`) VALUES (NULL, 'defaultGroup', '0', '1');
INSERT INTO `GC06V1.2`.`forums` (`forumID`, `groupID`) VALUES (NULL, '1');
