...
<head>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel='shortcut icon' href='<?php echo WEB_ROOT; ?>media/icon.ico' />
    <title>Peer Review Centre</title>

    <?php defined('WEB_ROOT') ? null : define('WEB_ROOT', 'http://localhost:8888/databaseGC06/peer_review_centre/'); ?>
